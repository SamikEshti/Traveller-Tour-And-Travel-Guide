...
$get_bus_id = $_GET['edit-bus'] ?? '';
$edit_query = "SELECT * FROM buss_info WHERE id='{$get_bus_id}'";
...
if (isset($_POST['update'])) {
    $query = "UPDATE buss_info SET bus_from='{$bus_from}', bus_to='{$bus_to}', bus_name='{$bus_name}', bus_type='{$bus_type}', cost='{$cost}', seat='{$seat}'  WHERE id=$get_bus_id";
    mysqli_query($connection, $query);
    header("Location: all-transport.php?message=success");
}
                                    ...
                                    <div class="card-body text-left">
                                        <form action="" method="post">
                                            <div class="form-group">
                                                ...
                                                <input required name="bus_from" value="<?php echo $edit_row['bus_from'];?>" type="text" class="form-control" id="">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">To</label>
                                                <input required name="bus_to" value="<?php echo $edit_row['bus_to'];?>" type="text" class="form-control" id="">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Transport name</label>
                                                <input required name="bus_name" value="<?php echo $edit_row['bus_name'];?>" type="text" class="form-control" id="">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Transport name</label>
                                                <input required readonly name="bus_type" value="<?php echo $edit_row['bus_type'];?>" type="text" class="form-control" id="">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Cost</label>
                                                <input required name="cost" value="<?php echo $edit_row['cost'];?>" type="text" class="form-control" id="">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Seat</label>
                                                <input name="seat" type="text" value="<?php echo $edit_row['seat'];?>" value="40" class="form-control"
                                                       id="">
                                            </div>
