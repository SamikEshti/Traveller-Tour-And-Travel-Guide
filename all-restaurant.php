                            ...
                            <div class="col-8">
                                <div class="card text-center">
                                    ...
                                    <p>
                                        ...
                                        $get_delete_bus = $_GET['delete-rest'] ?? '';
                                        $delete_query = "DELETE FROM restaurants WHERE id=$get_delete_bus";
                                        ...
                                        <table class="table" id="hotel_table">
                                            ...
                                            while ($data = mysqli_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $data['restaurant_cost']; ?>/=</td>
                                                    <td><a href="edit-restaurant.php?edit-restaurant=<?php echo $data['id']; ?>"
                                                           class="btn btn-info">Edit</a>
                                                        <a onclick="return confirm('Are you sure want to delete ?')"
                                                           class="btn btn-danger"
                                                           href="?delete-rest=<?php echo $data['id']; ?>">Delete</a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
