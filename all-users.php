                            ...
                            <div class="col-8">
                                <div class="card text-center">
                                    ...
                                    <p>
                                        ...
                                        $get_delete_bus = $_GET['delete-user'] ?? '';
                                        $delete_query = "DELETE FROM users WHERE id=$get_delete_bus";
                                        ...
                                        <table class="table" id="hotel_table">
                                            ...
                                            while ($data = mysqli_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="edit-user.php?edit-user=<?php echo $data['id']; ?>"
                                                           class="btn btn-info">Edit</a>
                                                        <a onclick="return confirm('Are you sure want to delete ?')"
                                                           class="btn btn-danger"
                                                           href="?delete-user=<?php echo $data['id']; ?>">Delete</a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
