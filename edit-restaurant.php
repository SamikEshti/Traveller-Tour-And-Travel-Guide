...
$get_restaurant_id = $_GET['edit-restaurant'] ?? '';
$edit_query = "SELECT * FROM restaurants WHERE id='{$get_restaurant_id}'";
...
if (isset($_POST['add_new_restaurant'])) {
    $query = "UPDATE restaurants SET location='{$location}', restaurant_name='{$restaurant_name}', food_type='{$food_type}', restaurant_cost='{$restaurant_cost}' WHERE id=$get_restaurant_id";
    mysqli_query($connection, $query);
    header("Location: all-restaurant.php?message=success");
}
                                    ...
                                    <div class="card-body text-left">
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required name="restaurant_name" value="<?php echo $edit_row['restaurant_name'];?>" type="text" class="form-control"
                                                       id="">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Restaurant Name</label>
                                                <input required name="food_type" value="<?php echo $edit_row['food_type'];?>" type="text" class="form-control"
                                                       id="">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Restaurant cost</label>
                                                <input required name="restaurant_cost" value="<?php echo $edit_row['restaurant_cost'];?>" type="text" class="form-control"
                                                       id="">
                                            </div>
